...
export default function SettingsClient({ user, telegramBotUsername }: { user: UserData; telegramBotUsername: string | null }) {
  ...
  const telegramLink = telegramBotUsername ? `https://t.me/${telegramBotUsername}?start=${user.id}` : null;
    ...
    <div className="pt-8 lg:pt-0 max-w-3xl">
      ...
      <div className="card-dark p-6 mb-4">
        ...
        {user.telegramChatId ? (
          ...
          <div>
            <p className="text-xs text-white/30 mb-3">Click the button below to open Telegram and connect your account.</p>
            <a
              href={telegramLink}
              target="_blank"
              rel="noopener noreferrer"
              className="btn-glow inline-flex items-center gap-2 rounded-xl bg-[#2AABEE] px-6 py-2.5 text-sm font-semibold text-white hover:bg-[#229ED9] transition-all"
            >
