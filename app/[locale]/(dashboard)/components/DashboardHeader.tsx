    ...
    <header className="flex h-16 items-center justify-end border-b border-white/5 bg-transparent px-4 sm:px-8">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-white/10 px-3.5 py-2 text-sm text-white/50 transition-all hover:bg-white/5 hover:text-white/80 hover:border-white/20"
        >
